// Comprehensive Arabic translations for Media Pulse
...
const arTranslations = {
  "connection": {
    ...
    "tooltip": "حالة الاتصال: {{status}}"
  },
  "preview": {
    "responsivePreview": "معاينة متجاوبة",
    "toggleResponsivePreview": "تبديل وضع المعاينة المتجاوبة",
    "viewCurrentPage": "معاينة الصفحة الحالية بأحجام شاشات مختلفة",
    "selectDevice": "اختيار الجهاز",
    "mobileDevices": "أجهزة الجوال",
    "tabletDevices": "أجهزة اللوحي",
    "desktopDevices": "أجهزة سطح المكتب",
  ...
  "pages": {
    "systemInfo": {
      ...
      "subtitle": "الحصول على معلومات متخصصة حول نبض الإعلام ومفاهيم مراقبة وسائل الإعلام"
    }
  },
  "testPages": {
    "connectionTest": {
  ...
  "common": {
    ...
    "connection_status": {
      ...
      "tooltip": {
        "title": "حالة الاتصال",
        "description": "يعرض حالة الاتصال الحالية بخدمات البيانات الفورية",
        "polling": "تحديث البيانات كل {{seconds}} ثوانٍ"
      }
    },
    "recommendations": {
      "title": "موصى به لك",
      "frequentVisit": "تزور هذا كثيرًا",
      "recentActivity": "تم رصد نشاط حديث",
      "trendingTopics": "مواضيع رائجة متاحة",
      "newFeature": "ميزة جديدة متاحة",
      "contentEngagement": "بناءً على نشاطك",
      "suggested": "مقترح لك"
    }
  },
  "reports": {
    ...
    "smartReportsDescription": "دمج مصادر بيانات متعددة في تقارير شاملة",
    "smartReportName": "اسم التقرير",
    "smartReportNamePlaceholder": "أدخل اسم التقرير",
    "reportComponents": "مكونات التقرير",
    "excellenceComponent": "مؤشرات التميز",
    "socialMediaComponent": "وسائل التواصل الاجتماعي",
    "sentimentComponent": "تحليل المشاعر",
    "entitiesComponent": "الكيانات",
    ...
    "reportExported": "تم إنشاؤه وجاهز للعرض",
    "reportCreationFailed": "فشل إنشاء التقرير",
    "refreshingReports": "تحديث التقارير",
    "reportsUpdatedAutomatically": "سيتم تحديث التقارير تلقائيًا",
    "socialMediaReport": "تقرير وسائل التواصل الاجتماعي",
    "sentimentReport": "تقرير تحليل المشاعر",
    "reportTemplates": "قوالب التقارير",
    "latestChanges": "أحدث التغييرات",
    "sentimentAnalysis": "تحليل المشاعر",
    "sentimentAnalysisDescription": "تتبع وتحليل المشاعر عبر جميع المنصات المراقبة"
  },
  ...
  "reporting": {
    ...
    "csvExportDesc": "تم تصدير البيانات بتنسيق CSV بنجاح",
    "textExportDesc": "تم تصدير التقرير كنص بنجاح",
    "comingSoon": "قريبًا",
    "formatNotSupported": "التصدير إلى {format} سيكون متاحًا قريبًا",
    "exportError": "فشل التصدير",
    "exportErrorDesc": "حدث خطأ أثناء تصدير التقرير. يرجى المحاولة مرة أخرى.",
    "generateReport": "إنشاء تقرير",
    "export": "تصدير",
    "reportParameters": "معايير التقرير",
    "configureReportDesc": "تكوين معايير التقرير الخاص بك",
    "reportType": "نوع التقرير",
    "selectReportType": "اختر نوع التقرير",
    "sentimentAnalysis": "تحليل المشاعر",
    "keywordPerformance": "أداء الكلمات الرئيسية",
    "platformBreakdown": "تقسيم المنصات",
    ...
    "overviewDesc": "نظرة عامة على بياناتك الحالية",
    "averageSentiment": "متوسط المشاعر",
    "platforms": "المنصات",
    "reportPeriod": "فترة التقرير",
    "sentimentTrendsDesc": "تتبع المشاعر عبر الإطار الزمني المحدد",
    "noSentimentData": "لا توجد بيانات مشاعر متاحة للفترة المحددة",
    "platformDistribution": "توزيع المنصات",
    "posts": "المنشورات",
    "noPostData": "لا توجد بيانات منشورات متاحة للفترة المحددة",
    "occurrences": "التكرارات",
    "noKeywordData": "لا توجد بيانات كلمات رئيسية متاحة للفترة المحددة",
    "exportOptions": "خيارات التصدير",
    "exportDesc": "تنزيل التقرير بتنسيقات مختلفة",
    "scheduledReports": "التقارير المجدولة",
    "scheduledReportsDesc": "تكوين إنشاء التقارير التلقائي",
    "active": "نشط",
    "scheduled": "مجدول",
    "history": "التاريخ",
    "noActiveReports": "لا توجد تقارير مجدولة نشطة. قم بإنشاء تقرير مجدول جديد ليظهر هنا.",
    "noScheduledReports": "لا توجد تقارير مجدولة. قم بجدولة تقرير ليظهر هنا.",
    "noReportHistory": "لا يوجد تاريخ للتقارير. ستظهر التقارير التي تم إنشاؤها هنا."
  },
  ...
  "entity": {
    ...
    "trends": {
      ...
      "noPlatformData": "لا توجد بيانات للمنصة متاحة"
    },
    "errorLoadingEntities": "خطأ في تحميل الكيانات",
    "testPage": "صفحة اختبار مراقبة الكيانات",
    "directAccessTest": "اختبار الوصول المباشر",
    "enterEntityId": "أدخل معرف الكيان",
    "entityIdPlaceholder": "مثال: 1، 2، 3...",
    "goToEntityPage": "الذهاب إلى صفحة الكيان",
    "availableEntities": "الكيانات المتاحة",
    "analytics": {
      "sentimentAnalysis": "تحليل المشاعر",
  ...
  "mediaCenter": {
    ...
    "noWebsite": "لا يوجد موقع إلكتروني متاح",
    "browse": "تصفح",
  ...
  "dashboard": {
    ...
    "search": "بحث",
    "searchKeywords": "البحث عن الكلمات الرئيسية والمواضيع والكيانات...",
    ...
    "searchError": "خطأ في تحميل نتائج البحث",
    "likes": "إعجابات",
    "comments": "تعليقات",
    "shares": "مشاركات",
    "custom": "نطاق مخصص",
    ...
    "topKeywords": "أهم الكلمات الرئيسية",
    "mentionsOverTime": "الإشارات على مدار الوقت",
    ...
    "widgets": {
      ...
      "mediaSources": "المصادر الإعلامية",
      ...
      "unknownType": "نوع غير معروف من المكونات",
      "errorRendering": "خطأ في عرض المكون",
    ...
    "alertMessages": {
      "negativeSentimentSpike": "تم اكتشاف زيادة في المشاعر السلبية حول 'خدمة العملاء'",
      "vipMention": "تم اكتشاف ذكر لشخصية هامة: 'الشيخ محمد' في مقال إخباري",
      "trendingKeyword": "كلمة رئيسية متداولة جديدة: 'الابتكار الرقمي'",
      "unusualActivity": "تم اكتشاف نشاط غير عادي على تويتر"
    },
    "sources": "المصادر",
    "sentiment": "المشاعر",
    "languages": "اللغات",
    ...
    "marketShareIncrease": "زيادة حصة السوق بنسبة 5.2٪ هذا الشهر",
  ...
  "supportCenter": {
    ...
    "knowledgeArticle": {
      ...
      "helpfulVotes": "تصويتات مفيدة",
      "share": "مشاركة",
      "print": "طباعة",
      "wasThisHelpful": "هل كان هذا المقال مفيدًا؟",
      "yes": "نعم",
      "no": "لا",
      "relatedTopics": "مواضيع ذات صلة",
      "feedbackThankYou": "شكرًا على ملاحظاتك",
      "feedbackReceived": "ملاحظاتك تساعدنا في تحسين قاعدة المعرفة لدينا.",
      ...
      "thankYouForFeedback": "شكرًا على ملاحظاتك",
      "needMoreHelp": {
  ...
  "loginRequired": {
    ...
    "description": "تحتاج إلى تسجيل الدخول للوصول إلى هذه الميزة.",
    "loginButton": "تسجيل الدخول"
  },
  "needHelp": {
    "title": "هل تحتاج إلى مساعدة؟",
    "description": "تحقق من الأسئلة الشائعة وقاعدة المعرفة للحصول على إجابات سريعة للأسئلة الشائعة",
    "browseFaq": "تصفح الأسئلة الشائعة",
  ...
  "statusTickets": {
    ...
    "in-progress": "التذاكر قيد التقدم",
  ...
  "statusTicketsDescription": {
    ...
    "resolved": "التذاكر التي تم حلها بواسطة فريق الدعم",
  ...
  "ticketDetail": {
    ...
    "updateTicketStatusDescription": "تغيير حالة تذكرة الدعم هذه",
    "updating": "جاري التحديث...",
    "updateStatus": "تحديث الحالة",
    "responseAdded": "تمت إضافة الرد",
    "responseAddedDescription": "تمت إضافة ردك بنجاح إلى التذكرة.",
    "responseError": "خطأ في إضافة الرد",
    "statusUpdated": "تم تحديث الحالة",
    "statusUpdatedDescription": "تم تحديث حالة التذكرة بنجاح.",
    "statusUpdateError": "خطأ في تحديث الحالة",
    "loginRequired": {
      "title": "تسجيل الدخول مطلوب",
      "description": "تحتاج إلى تسجيل الدخول لعرض تفاصيل التذكرة.",
      "loginButton": "تسجيل الدخول"
    },
    "alerts": {
      "resolved": {
        "title": "تم حل هذه التذكرة",
        "description": "إذا كنت لا تزال تواجه مشكلات، يمكنك إضافة رد جديد أو إنشاء تذكرة جديدة."
      },
      "closed": {
        "title": "تم إغلاق هذه التذكرة",
        "description": "للحصول على مزيد من المساعدة، يرجى إنشاء تذكرة دعم جديدة."
      }
    },
    "closeTicketDialog": {
      "title": "إغلاق هذه التذكرة؟",
      "description": "هل أنت متأكد أنك تريد إغلاق هذه التذكرة؟ سيؤدي هذا إلى وضع علامة على المشكلة كحل وسيتم أرشفة التذكرة.",
      "cancel": "إلغاء",
      "confirm": "نعم، إغلاق التذكرة"
    },
    "ticketInfo": {
    ...
    "backToAllTickets": "العودة إلى جميع التذاكر",
