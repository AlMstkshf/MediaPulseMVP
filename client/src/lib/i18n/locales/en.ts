// Comprehensive English translations for Media Pulse
...
const enTranslations: Record<string, any> = {
  "connection": {
    ...
    "tooltip": "Connection Status: {{status}}"
  },
  "preview": {
    "responsivePreview": "Responsive Preview",
    "toggleResponsivePreview": "Toggle Responsive Preview Mode",
    "viewCurrentPage": "Preview current page at different screen sizes",
  ...
  "common": {
    ...
    "connection_status": {
      ...
      "tooltip": {
        ...
        "description": "Shows the current connection state to our real-time services",
        "polling": "Polling updates every {{seconds}} seconds"
      }
    },
    "recommendations": {
      "title": "Recommended for You",
      "frequentVisit": "You visit this often",
      "recentActivity": "Recent activity detected",
      "trendingTopics": "Trending topics available",
      "newFeature": "New feature available",
      "contentEngagement": "Based on your activity",
  ...
  "reports": {
    ...
    "smartReportsDescription": "Combine multiple data sources into comprehensive reports",
    "smartReportName": "Report Name",
    "smartReportNamePlaceholder": "Enter report name",
    ...
    "reportExported": "has been generated and is ready to view",
    "reportCreationFailed": "Report Creation Failed",
    "refreshingReports": "Refreshing Reports",
    "reportsUpdatedAutomatically": "Reports will be updated automatically",
    "socialMediaReport": "Social Media Report",
    "sentimentReport": "Sentiment Report",
    "reportTemplates": "Report Templates",
    "latestChanges": "Latest Changes",
    "sentimentAnalysis": "Sentiment Analysis",
    "sentimentAnalysisDescription": "Track and analyze sentiment across all monitored platforms"
  },
  ...
  "reporting": {
    ...
    "csvExportDesc": "Data exported as CSV successfully",
    "textExportDesc": "Report exported as text successfully",
    "comingSoon": "Coming Soon",
    "formatNotSupported": "Export to {format} will be available soon",
    "exportError": "Export Failed",
    "exportErrorDesc": "There was an error exporting your report. Please try again.",
    "generateReport": "Generate Report",
    "export": "Export",
    "reportParameters": "Report Parameters",
    "configureReportDesc": "Configure the parameters for your report",
    ...
    "overviewDesc": "Overview of your current data",
    "averageSentiment": "Average Sentiment",
    "platforms": "Platforms",
    "reportPeriod": "Report Period",
    "sentimentTrendsDesc": "Track sentiment across your selected timeframe",
    "noSentimentData": "No sentiment data available for the selected period",
    "platformDistribution": "Platform Distribution",
    "posts": "Posts",
    "noPostData": "No post data available for the selected period",
    "occurrences": "Occurrences",
    "noKeywordData": "No keyword data available for the selected period",
    "exportOptions": "Export Options",
    "exportDesc": "Download your report in various formats",
    "scheduledReports": "Scheduled Reports",
    "scheduledReportsDesc": "Configure automatic report generation",
    "active": "Active",
    "scheduled": "Scheduled",
    "history": "History",
    "noActiveReports": "No active scheduled reports. Create a new scheduled report to see it here.",
    "noScheduledReports": "No scheduled reports. Schedule a report to see it here.",
    "noReportHistory": "No report history. Generated reports will appear here."
  },
  "media": {
    "type": {
      "image": "Image",
  ...
  "dashboard": {
    "mainTitle": "Media Intelligence Dashboard",
    "overview": "Overview",
    "analytics": "Analytics",
    ...
    "search": "Search",
    "searchKeywords": "Search keywords, topics, entities...",
    ...
    "alertMessages": {
      "negativeSentimentSpike": "Negative sentiment spike detected for 'Customer Service'",
      "vipMention": "VIP mention detected: 'Sheikh Mohammed' in news article",
      "trendingKeyword": "New trending keyword: 'Digital Innovation'",
      "unusualActivity": "Unusual activity detected on Twitter"
    },
    "sources": "Sources",
    "sentiment": "Sentiment",
    "languages": "Languages",
    ...
    "marketShareIncrease": "5.2% market share increase this month",
    "downloadReport": "Download Report",
    "enableAlerts": "Enable Alerts",
    "alertsDisabled": "Alerts are currently disabled",
    ...
    "averageResponseTime": "Average response time to media inquiries",
    "notableImprovement": "Notable improvement from previous quarter",
    ...
    "sentimentDistribution": "Sentiment Distribution",
    "sentimentDescription": "Overall sentiment across all platforms",
    "viewDetailedAnalysis": "View detailed analysis",
    "recentMentions": "Recent Mentions",
    "viewAllMentions": "View all mentions",
    "platformActivity": "Platform Activity",
    "viewPlatformDetails": "View platform details",
    "exploreAllKeywords": "Explore all keywords",
    "sampleContent1": "We appreciate the quick response from @AjmanPolice regarding the traffic situation today. Great service!",
    "sampleContent2": "The new digital services launched by Ajman Police are making it much easier to complete transactions online.",
    "sampleContent3": "Traffic delays on Sheikh Zayed Road due to an accident. Ajman Police on the scene but delays expected.",
    "sentimentOverTime": "Sentiment Over Time",
    "sentimentTrendDescription": "Sentiment trend analysis chart will be displayed here showing changes over the selected time period.",
    "analyticsTab": "Analytics Dashboard",
    "analyticsDescription": "Access comprehensive analytics about media coverage, sentiment trends, and engagement metrics.",
    "socialTab": "Social Media Insights",
    "socialDescription": "Track mentions, engagement, and sentiment across all social media platforms.",
    "mediaTab": "Media Center Dashboard",
    "mediaDescription": "Access press releases, media contacts, and coverage reports in one centralized location.",
  ...
  "search": {
    ...
    "search": "Search",
    "searchPlaceholder": "Enter keywords, hashtags, or topics...",
    "filters": "Filters",
    "platforms": "Platforms",
    "sentiment": "Sentiment",
    "date": "Date",
    ...
    "advancedFiltersDescription": "Refine your search with additional criteria",
    "authorFilter": "Author filter",
    "authorFilterPlaceholder": "Enter author name or username",
